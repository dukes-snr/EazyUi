...
const Grainient: React.FC<GrainientProps> = ({
    ...
    useEffect(() => {
        ...
        // Add an extra setSize after a small delay to handle any late layout shifts
    ...
    return <div ref={containerRef} className={`relative block overflow-hidden ${className}`.trim()} style={{ width: '100%', height: '100%' }} />;
};
