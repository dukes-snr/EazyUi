...
const CANVAS_WORKSPACE_GUIDE_STEPS: GuideBubbleStep[] = [
    {
        ...
        body: 'These breadcrumbs identify the active project and take you back to the project library when you are ready to switch work.',
        placement: 'bottom',
    },
    {
        id: 'canvas-toolbar',
        ...
        body: 'Use the dock to switch between selecting and panning, undo or redo work, control zoom, and fit all screens into view.',
        tip: 'Use the hand tool to move around without accidentally selecting a screen.',
        placement: 'right',
    },
    {
        id: 'canvas-stage',
        targetId: 'canvas-stage',
        title: 'Select and organize screens',
        body: 'Drag screens to arrange the flow. Select one screen for its actions, or select several to move, edit, duplicate, or export them together.',
        tip: 'Double-click a screen when you want to edit its individual elements.',
        placement: 'top',
    },
    {
        ...
        body: 'Use these project controls to confirm save status, export screens, open settings, and manage your account.',
        placement: 'left',
    },
    {
        id: 'canvas-help-trigger',
        targetId: 'canvas-help-trigger',
        title: 'Keep learning as you work',
        body: 'Help contains focused tours, documentation, and the shortcut map. Reopen it whenever you enter a workflow you have not used before.',
        tip: 'The next tutorial introduces the AI chat panel and generation controls.',
        placement: 'right',
    },
];
